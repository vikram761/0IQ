  ...
  return (
    <>
      ...
      <section className=" relative pb-20 sm:h-[800px] h-[800px]  bg-cover bg-center  flex flex-col justify-center items-center text-center bg-gradient-to-tr bg-[#ffffff] bg-no-repeat ">
        <h1 className="sm:w-[70%] text-7xl sm:text-7xl md:text-9xl font-bold  max-sm:mx-4  mb-4 md:text-black pt-20">
          GRADER
        </h1>
        <h2 className="sm:w-[70%] text-3xl sm:text-4xl md:text-4xl font-semibold max-sm:mx-4 text-black flex items-center justify-center mb-8">
          A Digital AI Grader
        </h2>
